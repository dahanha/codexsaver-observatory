...
|---|---|---:|---|---:|---:|---:|---:|
| Create v2 smoke doc | docs | 1.00 | success (worker) | 0.55 | 45% | 1.0 | 2.46s |
| Add generated cost test | tests | 1.00 | success (worker) | 0.55 | 45% | 1.0 | 14.95s |
| Add package version metadata | small_code | 1.00 | success (preflight) | 0.00 | 100% | 1.0 | 0.03s |
| Document work-packet CLI | docs | 1.00 | success (worker) | 0.55 | 45% | 1.0 | 10.92s |
| Create Chinese v2 note | zh_docs | 1.00 | success (worker) | 0.55 | 45% | 1.0 | 2.42s |
