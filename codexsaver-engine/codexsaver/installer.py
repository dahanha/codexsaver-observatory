...
def _render_agents_block(project_name: str, profile: str) -> str:
    body = [
        ...
        "## Tool Priority",
        "",
        "- Delegate bounded low/medium-risk work to CodexSaver when the result is mechanically verifiable.",
        "- Codex may use `codex_approved=true` for non-protected tasks that do not match a fixed keyword.",
        ...
        "- structured data transformations, translation, and localization",
        ...
        "## Delegation Limits",
        "",
        "- Normal bounded tasks may include up to 20 context files.",
        "- Explicitly repetitive tasks may include up to 40 files.",
        "- Work packets default to 4 repair iterations and 600 changed lines, capped at 6 and 1000.",
        "- Codex retains final review and applies only verified patches.",
        "",
